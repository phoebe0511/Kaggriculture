...
🔴 **2026-08-26：search 產得出更好的動作，但網路學不起來。** 這是目前的瓶頸。
    ...
    search 本身（08-26，20 局，12 支對手）
      對純 gen0            20/20 局全贏   +25,871   p=1.9e-06
      對 8 位真實頂端玩家   現金比 0.615 -> 0.774
...
🩸 **下一步不是產更多資料。** 先回答「這些標籤學不學得起來」—— 只用 search
盤面微調 round6，看命中率推不推得到 0.95+。推不上去的話問題在編碼器
（`workflow.md` §5 第二號失敗模式），產再多資料都白費。四個選項見
08-26 journal §8。
